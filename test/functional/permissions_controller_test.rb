...
class PermissionsControllerTest < ActionController::TestCase
  ...
  test "should create permission" do
    assert_difference('Permission.count') do
      post :create, permission: { detail_id: @permission.detail_id, profile_id: @permission.profile_id, user_id: @permission.user_id }
    end
  ...
  test "should update permission" do
    put :update, id: @permission, permission: { detail_id: @permission.detail_id, profile_id: @permission.profile_id, user_id: @permission.user_id }
    assert_redirected_to permission_path(assigns(:permission))
  end
